...
interface IAaveDistributionManager {
  ...
  **/
   ...
   **/
   function getUserAssetData(address user, address asset, address rewardToken) external view returns (uint256);
   ...
   **/
   function getAssetData(address asset, address rewardToken) external view returns (uint256, uint256, uint256);
}
